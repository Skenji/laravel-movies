...
var deleteMovie = function deleteMovie(eventData) {
  var button = eventData.currentTarget;
  var dataset = button.dataset;
  var urlDelete = "/movies";
...
var saveMovie = function saveMovie(eventData) {
  var button = eventData.currentTarget;
  var dataset = button.dataset;
  var urlSave = "/movies";
  var formData = new FormData();
...
var attachEvents = function attachEvents() {
  var _iterator = _createForOfIteratorHelper(document.querySelectorAll(".button-favorite")),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var buttonFavorite = _step.value;
  ...
  var _iterator2 = _createForOfIteratorHelper(document.querySelectorAll(".button-delete")),
      _step2;

  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var buttonDelete = _step2.value;
